    ...
    <div class="footer2">
            ...
            <dl>
                ...
                <dd>
                    <ul>
                        ...
                        <li><a href="<?= $esurl ?>estate_service">別荘地のお庭・空き地の年間不動産管理サービス</a></li>
                    </ul>
                <dd>
        ...
        <div class="rightbox">
            ...
            <dl>
                <dd>
                    <ul>
                        <li><a href="<?= $esurl ?>thoughts">昨今のコメ価格の高騰で農家が思うこと</a></li>
                        <li><a href="<?= $esurl ?>faq_list">農業のよくある質問</a></li>
                    </ul>
                <dd>
            </dl>

            <ul>
                <li><a href="<?= $esurl ?>member_regist01">【太陽と野菜の直売所】（東浪見岡本農園）の会員募集中です！（事前登録）</a></li>
                <li><a href="<?= $esurl ?>recruit">【太陽と野菜の直売所】求人・アルバイト募集</a></li>
                <li><a href="<?= $esurl ?>well_recruit">井戸掘り職人を募集しています！</a></li>

                <li><a href="<?= $esurl ?>tanbo_buy">田んぼ買います！（一宮町東浪見地区）</a></li>
                <li><a href="<?= $esurl ?>grasspicking">草刈り代行サービス始めました</a></li>
                <li><a href="<?= $esurl ?>herbicides_service">除草剤散布サービス</a></li>
                <li><a href="<?= $esurl ?>inquire01">お問合せ・お申込み</a></li>
                <li><a href="<?= $esurl ?>index">トップページ</a> </li>
            </ul>
        </div>
    </div>
    <address>Copyright(c) Torami Okamoto Farm Corporation All rights reserved.</address>
