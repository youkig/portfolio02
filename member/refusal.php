...
<div id="main" class="container">
	...
	<p class="pankuzu"><a href="<?=$esurl?>">トップページ</a> | <a href="<?=$esurl?>member/mypage">マイページ</a> | 退会手続き</p>
	<div class="block">
	<h2>退会手続き</h2>

<p>会員を退会された場合には、登録されている会員情報はすべて削除され、会員専用の全ての機能を使用出来なくなります。</p>

<p>よろしければ、退会手続きへ進んでください。</p>
<?=$_SESSION["setid"]?>
<form action="refusal02" method="post">
